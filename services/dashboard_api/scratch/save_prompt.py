...
with open("/Users/mythilikotaru/Documents/supply-chain-ai/services/dashboard_api/scratch/system_prompt.txt", "w", encoding="utf-8") as out:
    out.write(prompt)

print("Saved prompt. Length:", len(prompt))
